/****************************************************************************
 *  Calculate P wave radiation pattern of moment tensor or double couple    *
 *                                                                          *
 *  Author: Dongdong Tian @ USTC                                            *
 *                                                                          *
 *  Revision History:                                                       *
 *      2014-04-28  Xiaohan Chen    Initial version.                        *
 *      2014-05-01  Dongdong Tian   modify to handle MT and DC              *
 *                                                                          *
 ****************************************************************************/
