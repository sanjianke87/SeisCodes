#!/usr/bin/env perl
#
# Convert Earth models in .nd format to homogeneous layers
#
# For the description of .nd format, refer to the documentation of TauP
#
use strict;
use warnings;

@ARGV == 2 or die "Usage: perl $0 input_model output_model\n";
my ($in, $out) = @ARGV;
...
# output layered model to output
# modify $DH to control the maximum thickness of each layer
